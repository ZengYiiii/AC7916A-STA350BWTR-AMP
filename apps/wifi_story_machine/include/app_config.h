...
//FIXME:是否打印信息从USB CDC口输出，默认关闭
#define USER_USE_USB_CDC_PRINTF             0
...
#define CONFIG_AUDIO_DEC_PLAY_SOURCE        "iis0"
...
#define TCFG_UART_COMM                      2     //UART通信
...
#define SPP_TRANS_DATA_EN                         0//FIXME: 待优化
#endif
...
#else
#define BT_NET_CFG_EN                             0     //从机 杰理配网专用(声调调音使用传输)
#endif

#define TRANS_DATA_EN                             1     //从机 传输数据(声调调音)
...
#define CONFIG_VIDEO_DEC_ENABLE             0  ///FIXME:1 //打开视频解码器
...
#else
#define TCFG_TOUCH_GT911_ENABLE             1//FIXME:1
#endif

#if TCFG_LCD_ILI9481_ENABLE
#define TCFG_TOUCH_FT6236_ENABLE            0//FIXME:1
#else
