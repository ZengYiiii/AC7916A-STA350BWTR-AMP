...
AUPACKRES_ADR=0xd9a000; [AUTO 请根据编译后FLASH INFO打印的实际地址填写,比如0x59a000]
AUPACKRES_LEN=0x141000; [AUTO 更新提示音资源打包后必须更新此实际长度,比如0x141000,建议根据后续资源升级的需求预留好空间]
AUPACKRES_OPT=1;
#endif

#if defined CONFIG_UI_ENABLE && defined CONFIG_UI_FILE_SAVE_IN_RESERVED_ZONE
UIPACKRES_FILE=packres/UIPACKRES;
UIPACKRES_ADR=0xedb000; [AUTO 请根据编译后FLASH INFO打印的实际地址填写,比如0x6db000]
UIPACKRES_LEN=0x123000; [AUTO 更新UI资源打包后必须更新此实际长度,比如0x123000, 建议根据后续资源升级的需求预留好空间]
UIPACKRES_OPT=1;
#endif
